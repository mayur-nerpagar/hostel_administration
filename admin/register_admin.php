...
// admin panel
    ...
    $query="INSERT into userRegistration(regNo,firstName,middleName,lastName,gender,contactNo,email,marks,password) values(?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('sssssisis',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$marks,$password);
    $stmt->execute();
...
<div class="col-sm-12 col-md-6 col-lg-4">
    ...
    <div class="card-body">
            ...
            <div class="custom-control custom-radio">
                ...
                <label class="custom-control-label" for="customRadio1">Required <code>Extra 2000 Rs. Per Month</code></label>
            </div>
            <div class="custom-control custom-radio">
